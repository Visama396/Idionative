...
class Course(models.Model):
    ...
    slug = models.CharField(max_length=200, unique=True, default=title.lower().replace(' ', '-'), null=False)
...
class Unit(models.Model):
    ...
    slug = models.CharField(max_length=100, unique=True, default=title.lower().replace(' ', '-'), null=False)
    description = models.TextField()
